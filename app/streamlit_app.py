...
def _render_step_navigation() -> None:
    ...
    st.html(
        """
        <style>
        .st-key-step-navigator { gap: 0.25rem !important; align-items: baseline !important; }
        .st-key-step-navigator [data-testid="stButton"] { margin: 0 !important; padding: 0 !important; }
