...
function Publish-Head {
    ...
    if ($branch -ne 'main' -and -not (Confirm-Yes ((U '0J/RgNC+0LTQvtC70LbQuNGC0Yw/IFt5L05d')))) { Write-Host (U '0J7RgtC80LXQvdC10L3Qvi4g0JjQt9C80LXQvdC10L3QuNGPINC90LUg0YHQvtGF0YDQsNC90LXQvdGLLg==') -ForegroundColor Yellow; return }
...
function Invoke-WorkingPush {
    ...
    Write-Host (U '0JHRg9C00YPRgiDRgdC+0YXRgNCw0L3QtdC90Ysg0YTQsNC50LvRizo=') -ForegroundColor Yellow; $status.Lines | ForEach-Object { Write-Host $_ }
    ...
    if (-not (Confirm-Yes (U '0KHQvtGF0YDQsNC90LjRgtGMINCS0KHQlSDQv9C+0LrQsNC30LDQvdC90YvQtSDQuNC30LzQtdC90LXQvdC40Y8/IFt5L05d'))) { Write-Host (U '0J7RgtC80LXQvdC10L3Qvi4g0JjQt9C80LXQvdC10L3QuNGPINC90LUg0YHQvtGF0YDQsNC90LXQvdGLLg==') -ForegroundColor Yellow; return }
    ...
    Write-Host ((U '0JjQt9C80LXQvdC10L3QviDRhNCw0LnQu9C+0LI6') + " $(@($status.Lines).Count)"); Write-Host ((U '0JrQvtC80LzQtdC90YLQsNGA0LjQuQ==') + ": $Message")
    if (-not (Confirm-Yes (U '0J/RgNC+0LTQvtC70LbQuNGC0Yw/IFt5L05d'))) { Write-Host (U '0J7RgtC80LXQvdC10L3Qvi4g0JjQt9C80LXQvdC10L3QuNGPINC90LUg0YHQvtGF0YDQsNC90LXQvdGLLg==') -ForegroundColor Yellow; return }
...
function Invoke-InstitutePush {
    ...
    if ([string]::IsNullOrWhiteSpace($changed.Text)) { Invoke-Git $inst @('switch',$base) | Out-Null; Invoke-Git $inst @('branch','-d',$branch) | Out-Null; Write-Host (U '0JPQntCi0J7QktCe') -ForegroundColor Green; Write-Host (U '0KDQtdC/0L7Qt9C40YLQvtGA0LjQuSDQmNC90YHRgtC40YLRg9GC0LAg0YPQttC1INGB0L7QtNC10YDQttC40YIg0LjRgdGC0L7Rh9C90LjQui4='); return }
    ...
    if (-not (Confirm-Yes (U '0KHQvtC30LTQsNCy0YwgUFI/IFt5L05d'))) { Write-Host (U '0J7RgtC80LXQvdC10L3Qvi4g0JjQt9C80LXQvdC10L3QuNGPINC90LUg0YHQvtGF0YDQsNC90LXQvdGLLg==') -ForegroundColor Yellow; return }
...
catch { $m=[string]$_.Exception.Message; Write-Host ''; Write-Host (U '0J7QodCi0JDQndCe0JLQm9CV0J3Qng==') -ForegroundColor Red; Write-Host ((U '0J/RgNC40YfQuNC90LA6') + ' ' + $(if ($m.StartsWith('KOMUS_HELPER: ')) { $m.Substring(14) } else { $m })) -ForegroundColor Yellow; Write-Host (U '0J3QtSDQstGL0L/QvtC70L3QtdC90Ysg0YHQu9C10LTRg9GO0YnQuNC1INC+0L/QtdGA0LDRhtC40Lgu'); exit 1 }
